...
class XGBoostOptimizer:
    def __init__(self,
        ...
        Args:
            X (pd.DataFrame): 特徵資料。
            y (pd.Series): 目標變數。
            model_type (str): 模型類型，'regressor' 或 'classifier'
    ...
    def optimize_params(self,
        ...
        Args:
            ...
            storage_path (str): Optuna 資料庫儲存路徑
        """
        ...
        self.study.optimize(self._objective, n_trials=optuna_n_trials, timeout=optuna_timeout,callbacks=[self._optuna_callback])
